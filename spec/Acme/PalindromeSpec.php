...
class PalindromeSpec extends ObjectBehavior
{
    ...
    function it_finds_a_palindrome_at_the_beginning()
    {
        $this->longestPalindrome("racecarabcbde")->shouldReturn("racecar");
    }

    function it_finds_a_palindrome_at_the_end()
    {
        $this->longestPalindrome("abc1232racecar")->shouldReturn("racecar");
    }
    ...
    function it_finds_a_palindrome_only_one_char_less_than_the_string()
    {
        $this->longestPalindrome('amom')->shouldReturn('mom');
        $this->longestPalindrome('aibohphobiaz')->shouldReturn('aibohphobia');
    }
